...
<section class="topgames">
	<div class="headings text-center">
		<h1 class="service font-weight-bold">Download Great Theft Auto V (GTA V)</h1>
		<p>Download GTA V for 100% free very easily</p>
	</div>
	...
	<div class="container content">
			...
			<h3>Don't Know About Great Theft Auto V?</h3>
			<p>If you don't know about <span class="font-weight-bold">Great Theft Auto V</span>. You can easily get this information also in our Website. We also provide the information about the games and in the Home Page of our Website, you get the information of any Games which you wanted to know you get it very easily. </p>

			<h3>How you get the Information about Great Theft Auto V in our Website?</h3>
			<h2>You can get the information about Great Theft Auto V in our Website by doing the following steps</h2>
			...
			<p><span class="font-weight-bold"> 2.</span> Your 'Setup' of GTA 5 will start downloading above your taskbar.</p>
			<p><span class="font-weight-bold"> 3.</span> When the downloading is completed, Your 'Setup of GTA 5' will automatic save to the 'Download' Folder of your PC.</p>
			<p><span class="font-weight-bold"> 4.</span>Double CLick on the 'Setup of Your GTA 5', its start loading.</p>
			<p><span class="font-weight-bold"> 5.</span>Give him all the permissions, and Click on 'Install' button and enjoy your game.</p>

				<div class="text-center">
					<img src="Images/gta5download.jpg" class="imglol">
					<h1 class="download">GTA 5</h1>
					<a href="http://www.mediafire.com/file/xqfl6jr6ebujr21/Grand_Theft_Auto_V.exe/file" class="button btn btn-success mb-4 mt-4 text-center" role="button">
					<i class="fas fa-arrow-up"> Download Now</i></a>					
				</div>

			<h3>These are the Grand Theft Auto V System Requirements (Minimum)</h3>
				...
				<p><span class="font-weight-bold">Grand Theft Auto V File Size:</span> 72 GB</p>
				...
				<h3>These are the Grand Theft Auto V System Requirements (Recommended)</h3>
