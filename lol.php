...
<section class="topgames">
	<div class="headings text-center">
		<h1 class="service font-weight-bold">Download Leauge of Legends (LOL)</h1>
		<p>Download Leauge of Legends for 100% free very easily</p>
	</div>
	...
	<div class="container content">
			...
			<h3>Don't Know About Leauge of Legends?</h3>
			<p>If you don't know about <span class="font-weight-bold">Leauge of Legends</span>. You can easily get this information also in our Website. We also provide the information about the games and in the Home Page of our Website, you get the information of any Games which you wanted to know you get it very easily. </p>

			<h3>How you get the Information about Leauge of Legends in our Website?</h3>
			<h2>You can get the information about Leauge of Legends in our Website by doing the following steps</h2>
			...
			<p><span class="font-weight-bold"> 2.</span> You will be redirect to the another page, and then click on the download button.</p>
			<p><span class="font-weight-bold"> 3.</span> Your 'Setup' of Leauge of Legends will start downloading above your taskbar.</p>
			<p><span class="font-weight-bold"> 4.</span> When the downloading is completed, Your 'Setup of Leauge of Legends' will automatic save to the 'Download' Folder of your PC.</p>
			<p><span class="font-weight-bold"> 5.</span>Double CLick on the 'Setup of Your Leauge of Legends', its start loading.</p>
			<p><span class="font-weight-bold"> 6.</span>Give him all the permissions, and Click on 'Install' button and enjoy your game.</p>

				<div class="text-center">
					<img src="Images/loldownload.jpg" class="imglol">
					<h1 class="download">Leauge of Legends</h1>
					<a href="https://lol.garena.com/download" class="button btn btn-success mb-4 mt-4 text-center" role="button"><i class="fas fa-arrow-up"> Download Now</i></a>					
				</div>
