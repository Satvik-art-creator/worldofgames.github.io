...
<section class="topgames">
	<div class="headings text-center">
		<h1 class="service font-weight-bold">Download Apex Legends</h1>
		<p>Download Apex Legends for 100% free very easily</p>
	</div>
	...
	<div class="container content">
			...
			<h3>Don't Know About Apex Legends?</h3>
			<p>If you don't know about <span class="font-weight-bold">Apex Legends</span>. You can easily get this information also in our Website. We also provide the information about the games and in the Home Page of our Website, you get the information of any Games which you wanted to know you get it very easily. </p>

			<h3>How you get the Information about Apex Legends in our Website?</h3>
			<h2>You can get the information about Apex Legends in our Website by doing the following steps</h2>
			...
			<p><span class="font-weight-bold"> 4.</span> Your 'Setup' of Apex Legends will start downloading above your taskbar.</p>
			<p><span class="font-weight-bold"> 5.</span>When the downloading is completed, Your 'Setup of Apex Legends' will automatic save to the 'Download' Folder of your PC.</p>
			<p><span class="font-weight-bold"> 6.</span>Double CLick on the 'Setup of Your Apex Legends', its start loading.</p>
			<p><span class="font-weight-bold"> 7.</span>Give him all the permissions, and Click on 'Install' button and enjoy your game.</p>

				<div class="text-center">
					<img src="Images/niceapex.jpg" class="imglol">
					<h1 class="download">Apex Legends</h1>
					<a href="https://www.ea.com/games/apex-legends" class="button btn btn-success mb-4 mt-4 text-center" role="button"><i class="fas fa-arrow-up"> Download Now</i></a>					
				</div>

			<h3>These are the Apex Legends System Requirements (Minimum)</h3>
				...
				<p><span class="font-weight-bold">Apex Legends File Size:</span> 72 GB</p>
				...
				<h3>These are the Apex Legends System Requirements (Recommended)</h3>
