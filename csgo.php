...
<section class="topgames">
	<div class="headings text-center">
		<h1 class="service font-weight-bold">Download Counter Strike: Global Offensive (CS:GO)</h1>
		<p>Download Counter Strike: Global Offensive for 100% free very easily</p>
	</div>
	...
	<div class="container content">
			...
			<h3>Don't Know About Counter Strike: Global Offensive?</h3>
			<p>If you don't know about <span class="font-weight-bold">Counter Strike: Global Offensive</span>. You can easily get this information also in our Website. We also provide the information about the games and in the Home Page of our Website, you get the information of any Games which you wanted to know you get it very easily. </p>

			<h3>How you get the Information about Counter Strike: Global Offensive in our Website?</h3>
			<h2>You can get the information about Counter Strike: Global Offensive in our Website by doing the following steps</h2>
			...
			<p><span class="font-weight-bold"> 2.</span> Your 'Setup' of Counter Strike: Global Offensive will start downloading above your taskbar.</p>
			<p><span class="font-weight-bold"> 3.</span> When the downloading is completed, Your 'Setup of Counter Strike: Global Offensive' will automatic save to the 'Download' Folder of your PC.</p>
			<p><span class="font-weight-bold"> 5.</span>Double CLick on the 'Setup of Your Counter Strike: Global Offensive', its start loading.</p>
			<p><span class="font-weight-bold"> 6.</span>Give him all the permissions, and Click on 'Install' button and enjoy your game.</p>

				<div class="text-center">
					<img src="Images/csgo.jpg" class="imglol">
